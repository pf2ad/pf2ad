...
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/pf2ad/pf2ad/2.3.4-SAMBA4/samba.inc
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/pf2ad/pf2ad/2.3.4-SAMBA4/samba.xml
...
cd /usr/local/pkg
fetch -o - -q https://raw.githubusercontent.com/pf2ad/pf2ad/2.3.4-SAMBA4/squid_winbind_auth.patch | patch -b -p0 -f
fetch -o /usr/local/pkg -q https://raw.githubusercontent.com/pf2ad/pf2ad/2.3.4-SAMBA4/squid.inc
